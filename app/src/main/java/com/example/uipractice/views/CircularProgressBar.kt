package com.example.uipractice.views
...
/**
 *
 * @link https://github.com/lopspower/CircularProgressBar
 */
class CircularProgressBar(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    var progressBarWidth: Float = resources.getDimension(R.dimen.default_circle_progress_stroke_width)
        set(value) {
            field = value.dpToPx()
    ...
    var backgroundProgressBarWidth: Float = resources.getDimension(R.dimen.default_circle_progress__background_stroke_width)
        set(value) {
            field = value.dpToPx()
