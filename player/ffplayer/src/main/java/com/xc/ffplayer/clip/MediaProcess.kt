...
class MediaProcess {
    ...
    companion object {
        ...
        fun start(videoPath1:String, videoPath2:String, outputPath:String) {
            ...
            val duration = videoTrackFormat1.getLong(MediaFormat.KEY_DURATION)
...
//            val videoTrackFormat2 = mediaExtractor1.getTrackFormat(videoTrackIndex1)
//            val audioTrackFormat2 = mediaExtractor1.getTrackFormat(audioTrackIndex1)
